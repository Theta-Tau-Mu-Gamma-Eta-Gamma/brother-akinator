...
class QuestionView(arcade.View):
    ...
    def on_draw(self):
        ...
        self.ui.draw()
        arcade.draw_text(self.number, WINDOW_WIDTH / 2 - 372, WINDOW_HEIGHT / 2 + 218, constants.COLOR_GOLD, font_size=16, anchor_x="center")
    ...
    def show_next_question(self):
        next_question = QuestionView("Does it jiggle?", self.number + 1)
        self.window.show_view(next_question)
